...
|---------|-----|---------------|
| **Lucide** | `lucide` | ~500 |
| **Heroicons** | `heroicons` | ~500 |
| **Material Icons** | `material` | ~500 |
| **Font Awesome 6** | `fontawesome` | ~400 |
| **Remix Icon** | `remix` | ~400 |
| **Phosphor Icons** | `phosphor` | ~400 |
| **Feather Icons** | `feather` | ~200 |
